...
export default {
  ...
  methods: {
    ...
    newCity(cityname) {
      ...
      this.$store.dispatch('FETCH_5DAYS', cityname)  // 5일치 날씨 데이터
    },
  }
}
...
/* @font-face {
        ...
        src: url('../weather-icons-master/_docs/gh-pages/font/weathericons-regular-webfont.eot');
        src: url('../weather-icons-master/_docs/gh-pages/font/weathericons-regular-webfont.eot?#iefix') format('embedded-opentype'), 
        url('../weather-icons-master/_docs/gh-pages/font/weathericons-regular-webfont.woff2') format('woff2'), 
        url('../weather-icons-master/_docs/gh-pages/font/weathericons-regular-webfont.woff') format('woff'), 
        url('../weather-icons-master/_docs/gh-pages/font/weathericons-regular-webfont.ttf') format('truetype'),
        url('../weather-icons-master/_docs/gh-pages/font/weathericons-regular-webfont.svg#weather_iconsregular') format('svg');
        font-weight: normal;
        font-style: normal;
      } */
